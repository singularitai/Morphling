...
#hp = from tensorflow.plugins.hprams.api import HParams
from glob import glob
import os, pickle

# Default hyperparameters
hp = {'num_mels':80, 'rescale':True, 'rescaling_max':0.9, 'max_mel_frames':900, 'use_lws':False, 'n_fft':800, 'hop_size':200, 'win_size':800, 'sample_rate':16000, 'frame_shift_ms':None, 'signal_normalization':True, 'allow_clipping_in_normalization':True, 'symmetric_mels':True, 'max_abs_value':4., 'normalize_for_wavenet':True, 'clip_for_wavenet':True,'preemphasize':True, 'preemphasis':0.97, 'min_level_db':-100,'ref_level_db':20, 'fmin':55, 'fmax':7600, 'power':1.5, 'griffin_lim_iters':60}
